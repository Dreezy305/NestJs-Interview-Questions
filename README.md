...
The req object represents the HTTP request and has properties for the request query string, parameters, body, HTTP headers. In other wors, it contains client-side request details.
