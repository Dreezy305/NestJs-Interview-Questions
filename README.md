...
| 13   | [What are providers in Nestjs](#How-are-providers-in-nestjs)                                                               |
...
Request object properties can be accessed by using the dedicated decorators. these include: ```@Body()``` ,  ```@Query()``` etc.
